...
//gir kendi ıd ni kanka
    if (user.id !== '519236223899009037' && user.id !== '390489053516005386') return interaction.reply({ embeds: [new EmbedBuilder().setColor('Random').setDescription('❌ Bu komut yalnızca bot geliştiricisi içindir.')], ephemeral: true })
